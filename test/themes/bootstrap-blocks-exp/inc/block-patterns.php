 ...
 * @return void
 */
function bootstrap_hooks_register_block_patterns() {
	 ...
	 */
	$block_patterns = apply_filters( 'bootstrap_hooks_block_patterns', $block_patterns );

	foreach ( $block_patterns as $block_pattern ) {
		$pattern_file = get_theme_file_path( '/inc/patterns/' . $block_pattern . '.php' );

		register_block_pattern(
			'bootstrap-hooks/' . $block_pattern,
			require $pattern_file
		);
	}
}
add_action( 'init', 'bootstrap_hooks_register_block_patterns', 9 );